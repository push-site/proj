...
if((i < len)){
var k = (ks[i]);
var G__26153 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__26154 = (i + (1));
m = G__26153;
i = G__26154;
continue;
...
return reagent.impl.component.global$module$react.Children.toArray(G__26155);
})());
} else {
var v = temp__5737__auto__;
...
var G__26167 = c;
var G__26167__$1 = (((G__26167 == null))?null:G__26167.constructor);
if((G__26167__$1 == null)){
return null;
} else {
return G__26167__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__26168 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26169 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26169);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26168);
}});
...
var c = this;
var G__26173_26175 = goog.object.get(c,"cljsRatom");
if((G__26173_26175 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26173_26175);
}
...
var renders_26176 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_26177 = cljs.core.first(cljs.core.vals(renders_26176));
...
if((cljs.core.count(renders_26176) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26176))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26177)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26177], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26178 = o;
goog.object.set(G__26178,cljs.core.name(k),v);
